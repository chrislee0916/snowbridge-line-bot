 ...
 */
async function createSignIn(keyObj, userId, name, phone, createAt) {
 ...
 * }]
 * */
async function getSignInList(userId, name, phone, limit, skip, sort) {
    return new Promise((resolve, reject) => {
 ...
 * 200 code return Body: {status: 'confirmed'}
 */
async function uploadTemplate(keyObj, pdfContant, createAt) {
    return new Promise((resolve, reject) => {
        const request = gtx.newTransaction([keyObj.pubKey]);
 ...
 *  */
async function createSignature(keyObj, userId, pdfContant, createAt) {
    return new Promise((resolve, reject) => {
        const request = gtx.newTransaction([keyObj.pubKey]);
 ...
 * }
 **/
async function getSignatureList(userId, name, phone, limit, skip, sort) {
    return new Promise((resolve, reject) => {
